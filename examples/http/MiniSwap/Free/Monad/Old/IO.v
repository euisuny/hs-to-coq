...
Definition Writer (A : Type) := itree (WriterEvent A).
...
(** TODO: We could probably make a generic version of this in MONAD.
    First make an inductive variant IM of itree.  Then write a "take"
    function that converts from [itree E X] to [IM E (option X)].  Then
