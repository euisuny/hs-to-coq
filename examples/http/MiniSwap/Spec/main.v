...
Definition ___arr : ident := 96%positive.
Definition ___builtin_ais_annot : ident := 28%positive.
...
Definition ___i : ident := 95%positive.
Definition _accept : ident := 90%positive.
Definition _accept_connection : ident := 129%positive.
Definition _add_to_fd_set : ident := 132%positive.
Definition _addr : ident := 150%positive.
Definition _addr_len : ident := 153%positive.
Definition _bind : ident := 86%positive.
Definition _bind_socket : ident := 154%positive.
Definition _buffer : ident := 105%positive.
Definition _buffer_ptr : ident := 100%positive.
Definition _check_if_complete : ident := 102%positive.
Definition _close : ident := 84%positive.
Definition _complete : ident := 116%positive.
Definition _conn : ident := 107%positive.
Definition _conn_fd : ident := 113%positive.
Definition _conn_read : ident := 118%positive.
Definition _conn_st : ident := 124%positive.
Definition _conn_write : ident := 123%positive.
Definition _connection : ident := 23%positive.
Definition _curr : ident := 135%positive.
Definition _curr_fd : ident := 137%positive.
Definition _curr_st : ident := 136%positive.
Definition _es : ident := 144%positive.
Definition _exit : ident := 81%positive.
Definition _fd : ident := 16%positive.
Definition _fd_isset_macro : ident := 98%positive.
Definition _fd_set_macro : ident := 99%positive.
Definition _fd_zero_macro : ident := 97%positive.
Definition _head : ident := 127%positive.
Definition _htons : ident := 92%positive.
Definition _in_addr : ident := 5%positive.
Definition _init_store : ident := 155%positive.
Definition _last_msg : ident := 109%positive.
Definition _last_msg_len : ident := 110%positive.
Definition _last_msg_store : ident := 108%positive.
...
Definition _max_fd : ident := 130%positive.
Definition _maxsock : ident := 146%positive.
Definition _memcpy : ident := 82%positive.
Definition _memset : ident := 83%positive.
Definition _monitor_connections : ident := 138%positive.
Definition _new_connection : ident := 104%positive.
Definition _new_len : ident := 115%positive.
Definition _new_store : ident := 106%positive.
Definition _next : ident := 24%positive.
Definition _num_bytes_sent : ident := 21%positive.
Definition _num_bytes_to_send : ident := 122%positive.
Definition _num_ready : ident := 148%positive.
Definition _old_head : ident := 128%positive.
Definition _populate_response : ident := 111%positive.
Definition _port : ident := 152%positive.
Definition _process : ident := 125%positive.
Definition _process_connections : ident := 142%positive.
Definition _ptr : ident := 114%positive.
Definition _r : ident := 112%positive.
Definition _read_socket_ready : ident := 140%positive.
Definition _recv : ident := 88%positive.
Definition _request : ident := 119%positive.
Definition _request_buffer : ident := 18%positive.
Definition _request_len : ident := 17%positive.
Definition _reset_connection : ident := 121%positive.
Definition _response : ident := 120%positive.
Definition _response_buffer : ident := 20%positive.
Definition _response_len : ident := 19%positive.
Definition _response_ok : ident := 117%positive.
Definition _result : ident := 103%positive.
Definition _rs : ident := 133%positive.
...
Definition _select_loop : ident := 149%positive.
Definition _send : ident := 87%positive.
Definition _server_socket : ident := 143%positive.
Definition _set : ident := 94%positive.
...
Definition _socket__1 : ident := 126%positive.
Definition _socket_ready : ident := 139%positive.
...
Definition _timeout : ident := 145%positive.
Definition _timeval : ident := 13%positive.
Definition _tmp : ident := 131%positive.
Definition _tmp_head : ident := 147%positive.
Definition _tv_sec : ident := 11%positive.
Definition _tv_usec : ident := 12%positive.
Definition _write_socket_ready : ident := 141%positive.
Definition _ws : ident := 134%positive.
Definition _zeroize_addr : ident := 151%positive.
