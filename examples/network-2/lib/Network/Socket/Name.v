...
Definition getSocketName {sa} `{Network.Socket.Types.SocketAddress sa}
   : Network.Socket.Types.Socket -> IO.IO sa :=
  fun s =>
...
Definition socketPort
   : Network.Socket.Types.Socket -> IO.IO Network.Socket.Types.PortNumber :=
  fun s =>
    getSocketName s GHC.Base.>>=
    (fun sa =>
       match sa with
       | Network.Socket.Types.SockAddrInet port _ => GHC.Base.return_ port
...
Definition socketPortSafe
   : Network.Socket.Types.Socket ->
     IO.IO (option Network.Socket.Types.PortNumber) :=
  fun s =>
    getSocketName s GHC.Base.>>=
    (fun sa =>
       GHC.Base.return_ (match sa with
                         | Network.Socket.Types.SockAddrInet port _ => Some port
...
(* External variables:
     ...
     Network.Socket.Internal.throwSocketErrorIfMinus1Retry_
     Network.Socket.Types.PortNumber Network.Socket.Types.SockAddrInet
     Network.Socket.Types.SockAddrInet6 Network.Socket.Types.Socket
